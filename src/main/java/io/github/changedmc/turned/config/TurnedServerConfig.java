package io.github.changedmc.turned.config;
...
public class TurnedServerConfig {
    ...
    public static final ForgeConfigSpec.IntValue WHITE_LATEX_SPREAD_DELAY;
    ...
    static {
        ...
        WHITE_LATEX_SPREAD_DELAY = BUILDER.comment("How many tick to wait before the white latex spread?").defineInRange("whiteLatexSpreadDelay", 30, 0, Integer.MAX_VALUE);
